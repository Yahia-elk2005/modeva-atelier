const orderTemplate = (name, orderId, status, customMessage, orderDetailsHtml) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
            ...
            <table class="main" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td class="header">
                        ...
                        <div class="subtitle">Atelier Order Update</div>
                    </td>
                </tr>
                <tr>
                    <td class="body-content">
                        <h2 class="heading">Order #${orderId} - ${status}</h2>
                        <p class="text">Dear ${name},</p>
                        <p class="text">${customMessage}</p>
